...
class MyForgotPasswordWorker extends StatefulWidget {
  const MyForgotPasswordWorker({super.key});

  @override
  State<MyForgotPasswordWorker> createState() => _MyForgotPasswordWorkerState();
}

class _MyForgotPasswordWorkerState extends State<MyForgotPasswordWorker> {
